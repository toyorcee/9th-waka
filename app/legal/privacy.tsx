      ...
      >
        ...
        >
          ...
          >
            ...
            information when you use our delivery service application.
          </Text>
          ...
          <View className="mb-6">
            ...
            <View className="ml-4 mb-2">
              ...
              >
                • For riders: NIN, BVN, driver's license, and vehicle
                information
              </Text>
              <Text
                className={`text-sm leading-6 ${
          ...
          <View className="mb-6">
            ...
            >
              We collect location data to provide delivery services, track
              orders, and improve our services. Location data is only shared
              with assigned riders and is used solely for delivery purposes. You
              can control location permissions through your device settings.
            </Text>
          </View>
